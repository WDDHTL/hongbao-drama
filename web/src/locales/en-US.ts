export default {
  ...
  drama: {
    ...
    videoLanguageHint: 'Used as the default language preference for later video dialogue, dubbing, and delivery.',
    videoLanguages: {
      zhCN: 'Chinese',
      enUS: 'English',
      jaJP: 'Japanese',
    ...
    videoLanguageNotes: {
      zhCN: 'Default for Chinese-speaking short dramas',
      enUS: 'Suitable for global and bilingual distribution',
      jaJP: 'Suitable for anime and Japanese-market output',
      koKR: 'Suitable for Korean-style dialogue and localization'
    },
    style: 'Style',
    ...
    management: {
      ...
      videoIdea: 'Dialogue to Video',
      videoIdeaTitle: 'Send your script to AI',
      videoIdeaKicker: 'Direct workflow',
      videoIdeaGuideDesc: 'Paste a script or short idea and we will auto-break it into episodes, roles, and scenes, then start the workflow.',
      videoIdeaTagScript: 'Script intake',
      videoIdeaTagAuto: 'Auto breakdown',
      videoIdeaTagWorkflow: 'Workflow tracking',
      videoIdeaActionTitle: 'Submit script / idea',
      videoIdeaActionSubTitle: 'Paste the full script or a quick description',
      videoIdeaPlaceholder: 'Paste your script or describe the video you want to make',
      videoIdeaSubmit: 'Submit & generate',
      videoIdeaWorkflowLink: 'Open auto workflow',
      videoIdeaTip: 'Only video-related intents are supported; other chat or search queries will respond with “Not supported”.',
