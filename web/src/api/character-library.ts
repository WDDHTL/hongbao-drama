...
export const characterLibraryAPI = {
  ...
  // AI生成角色形象
  generateCharacterImage(characterId: string, model?: string, frameType?: string) {
    return request.post<{ message: string; image_generation: any }>(`/characters/${characterId}/generate-image`, {
      model,
