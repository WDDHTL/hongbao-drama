export default {
  ...
  drama: {
    ...
    videoLanguage: '视频语言',
    videoLanguageHint: '作为后续视频对白、配音和成片输出的默认语言偏好。',
    videoLanguages: {
      zhCN: '中文',
      enUS: '英文',
      jaJP: '日语',
    ...
    management: {
      overview: '项目概览',
      videoIdea: '对话生成视频',
      videoIdeaTitle: '把你的剧本交给 AI',
      videoIdeaKicker: '快速直连',
      videoIdeaGuideDesc: '粘贴剧本或简单想法，系统将自动拆解剧集、角色与场景，并启动生成。',
      videoIdeaTagScript: '剧本直连',
      videoIdeaTagAuto: '自动拆解',
      videoIdeaTagWorkflow: '工作流追踪',
      videoIdeaActionTitle: '提交剧本 / 想法',
      videoIdeaActionSubTitle: '支持粘贴完整剧本或几句场景描述',
      videoIdeaPlaceholder: '粘贴完整剧本或简单描述你想生成的视频想法',
      videoIdeaSubmit: '提交并生成',
      videoIdeaWorkflowLink: '查看自动工作流',
      videoIdeaTip: '仅支持生成视频相关的需求，其他聊天或搜索会直接回复“做不到”。',
      episodes: '章节管理',
      characters: '角色管理',
      scenes: '场景管理',
      projectInfo: '项目信息',
